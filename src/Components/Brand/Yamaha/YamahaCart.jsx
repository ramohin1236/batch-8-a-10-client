...
const YamahaCart = ({yamaha}) => {
    const{_id,productName,productURL1,productRatings,productDescription} = yamaha
    return (
        <div>
...
YamahaCart.propTypes = {
    yamaha : PropTypes.object
     }

export default YamahaCart;