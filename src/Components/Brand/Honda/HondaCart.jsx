...
const HondaCart = ({honda}) => {
    const{_id,productName,productURL1,productRatings,productDescription} = honda
    return (
        <div>
...
HondaCart.propTypes = {
   honda : PropTypes.object
     }
 

export default HondaCart;